...
| `tests/docs/` (25-document manifest) | every link, anchor and section reference in the published documentation resolves; every variable, route and command it names exists |
