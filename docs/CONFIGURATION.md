...
documents all 185 of them, one comment per variable, and `backend/tests/test_env_templates.py` fails
...
|---|---|---|
| `app/config.py` | **what exists** — 185 names, types, defaults, validators | 29 groups, each with an `env_prefix` |
